...
7. РасскажичтотакоеLoadAverage(LA)?
...
Собеседник должен написать: 255.255.255.248. 25.Что такое MapReduce? Как это работает?
Ответ: MapReduce — это модель вычисления некоторых наборов распределенных задач с использованием большого количества компьютеров (называемых «нодами»), образующих кластер.
...
• вики утверждает что чем больше проект тем эффективнее
использование статической типизации, соглашусь)) Минусы статической типизации:
