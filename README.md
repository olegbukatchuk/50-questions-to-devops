...
1.Комплируемые языки. Работу компилируемых языков можно представить следующей схемой, жизненный цикл программы представляет собой следующие этапы:
...
2.Интерпретируемые языки. Соответственно, жизненный цикл программы сводится к:
- Написание. 
- Выполнение.
...
3.Смешанного типа. Принцип работы языков смешанного типа (компилируемо- интерпретируемые) проиллюстрируем такой схемой:
